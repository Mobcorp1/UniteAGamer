...
class ArcLoadoutSeedData {
  ...
  static const List<ArcLoadoutWeaponSpec> weapons = [
    ...
    ArcLoadoutWeaponSpec(
      ...
      slots: ['Muzzle', 'Medium Magazine', 'Stock', 'Converter'],
      blueprintBased: true,
    ),
    ArcLoadoutWeaponSpec(
      name: 'Bobcat',
    ...
    ArcLoadoutWeaponSpec(
      ...
      slots: ['Muzzle', 'Light Magazine', 'Barrel'],
    ),
    ArcLoadoutWeaponSpec(
      name: 'Ferro',
      category: 'Battle Rifle',
      role: 'Heavy precision damage',
      slots: ['Muzzle', 'Underbarrel', 'Stock', 'Barrel'],
      craftable: true,
      gunsmithLevel: 2,
    ),
    ArcLoadoutWeaponSpec(
    ...
    ArcLoadoutWeaponSpec(
      ...
      slots: ['Underbarrel', 'Barrel', 'Converter'],
      craftable: true,
      gunsmithLevel: 1,
    ),
    ArcLoadoutWeaponSpec(
    ...
    ArcLoadoutWeaponSpec(
      ...
      slots: ['Underbarrel', 'Stock', 'Barrel'],
      craftable: true,
      gunsmithLevel: 2,
    ),
    ArcLoadoutWeaponSpec(
      ...
      slots: ['Muzzle', 'Underbarrel', 'Medium Magazine', 'Converter'],
      blueprintBased: true,
    ),
    ArcLoadoutWeaponSpec(
      name: 'Torrente',
