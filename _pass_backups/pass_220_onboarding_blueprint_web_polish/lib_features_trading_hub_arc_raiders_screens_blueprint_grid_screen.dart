  ...
  Widget _buildBottomControls(
    ...
    final cards = <Widget>[
      barrelCard(
        ...
        children: [SizedBox(width: 420, child: _buildSearchAppBarTitle())],
      ),
      barrelCard(
        icon: Icons.filter_alt_rounded,
        title: 'Filters',
        subtitle: 'Keep the collection visible and rotate your filter set.',
        children: [
          barrelChip(
          ...
          barrelChip(
            ...
            onTap: () =>
                setState(() => _selectedFilter = ArcBlueprintFilter.duplicates),
          ),
        ],
      ),
      barrelCard(
            ...
            onSelected: (value) {
              switch (value) {
                ...
                case 'reset':
                  ...
                  return;
                case 'search':
                  setState(() => _commandBarrelIndex = 0);
                  return;
                case 'filters':
                  setState(() => _commandBarrelIndex = 1);
                  return;
                case 'select':
                  setState(() {
                    _commandBarrelIndex = 4;
                    _selectionMode = true;
                  });
                  return;
              }
