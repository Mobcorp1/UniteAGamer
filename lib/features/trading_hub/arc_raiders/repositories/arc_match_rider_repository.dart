...
class ArcMatchRiderRepository {
  ...
  ArcMatchObjectiveSignals _objectiveSignalsFromProfile(
    ...
    return ArcMatchObjectiveSignals(
      ...
      questIds: <String>[...profile.questFocusIds, ...profile.matchQuestIds],
      ...
      recommendedMapIds: profile.matchRecommendedMapIds,
      recommendedConditionIds: profile.matchRecommendedConditionIds,
