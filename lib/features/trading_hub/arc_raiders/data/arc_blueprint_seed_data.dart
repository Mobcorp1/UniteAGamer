...
class ArcBlueprintSeedData {
  ...
  static const List<ArcBlueprint> blueprints = [
    ...
    ArcBlueprint(
      id: 'crash-mat',
      name: 'Crash Mat',
      category: 'Riven Tides',
      group: 'Row 2',
      sortOrder: 13,
      rarity: ArcBlueprintRarity.rare,
      icon: Icons.vertical_align_bottom_rounded,
      imageAssetPath: '${_base}crash-mat.webp',
      intelHint:
          'Riven Tides blueprint. Tester-confirmed on Riven Tides day raid. Use Riven Tides reports until wider intel proves other maps.',
    ),
    ArcBlueprint(
      id: 'bobcat',
      name: 'Bobcat',
    ...
    ArcBlueprint(
      ...
      imageAssetPath: '${_base}tactical-mk-3-smoke.webp',
      intelHint:
          'Riven Tides-era smoke augment. Treat as global unless user intel proves a stricter route.',
    ),
    ArcBlueprint(
      id: 'smoke-grenade',
      name: 'Smoke Grenade',
    ...
    ArcBlueprint(
      ...
      imageAssetPath: '${_base}white-flag.webp',
      intelHint:
          'Riven Tides blueprint. Keep initial reports tied to Riven Tides until user intel says otherwise.',
    ),
    ArcBlueprint(
    ...
    ArcBlueprint(
      ...
      imageAssetPath: '${_base}powered-descender.webp',
      intelHint:
          'Riven Tides blueprint. Tester-confirmed on Riven Tides day raid and Night Raid.',
    ),
    ArcBlueprint(
      id: 'compensator-iii',
