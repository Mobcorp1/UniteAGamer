...
enum ArcRaidType { fullRaid, quickRaid, lateRaid }

enum ArcEntryTime { early, mid, late, unknown }

enum ArcTimeOfDay { dawn, day, dusk, night, unknown }
...
extension ArcTimeOfDayX on ArcTimeOfDay {
  String get label {
    switch (this) {
      case ArcTimeOfDay.dawn:
        return 'Dawn';
      case ArcTimeOfDay.day:
        return 'Day';
      case ArcTimeOfDay.dusk:
        return 'Dusk';
