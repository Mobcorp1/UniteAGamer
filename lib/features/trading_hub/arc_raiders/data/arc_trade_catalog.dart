...
class ArcTradeCatalog {
  static const List<ArcTradeCatalogItem> items = <ArcTradeCatalogItem>[
    ...
    // Bench upgrade surplus resource aliases.
    ArcTradeCatalogItem(id: 'wasp-drivers', name: 'Wasp Drivers', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'rusted-gears', name: 'Rusted Gears', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'sentinel-firing-cores', name: 'Sentinel Firing Cores', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'synthesized-fuel', name: 'Synthesized Fuel', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'pop-triggers', name: 'Pop Triggers', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'laboratory-reagents', name: 'Laboratory Reagents', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'explosive-compounds', name: 'Explosive Compounds', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'rocketeer-drivers', name: 'Rocketeer Drivers', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'power-cables', name: 'Power Cables', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'hornet-drivers', name: 'Hornet Drivers', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'industrial-batteries', name: 'Industrial Batteries', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'bastion-cells', name: 'Bastion Cells', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'cracked-bioscanners', name: 'Cracked Bioscanners', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'durable-cloth', name: 'Durable Cloth', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'tick-pods', name: 'Tick Pods', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'rusted-shut-medical-kits', name: 'Rusted Shut Medical Kits', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'surveyor-vaults', name: 'Surveyor Vaults', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'damaged-heat-sinks', name: 'Damaged Heat Sinks', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'snitch-scanners', name: 'Snitch Scanners', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'fried-motherboards', name: 'Fried Motherboards', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'leaper-pulse-units', name: 'Leaper Pulse Units', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'arc-powercells', name: 'ARC Powercells', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'toasters', name: 'Toasters', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'arc-motion-cores', name: 'ARC Motion Cores', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'fireball-burners', name: 'Fireball Burners', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'motors', name: 'Motors', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'bombardier-cells', name: 'Bombardier Cells', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: true),
    ArcTradeCatalogItem(id: 'dog-collar', name: 'Dog Collar', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'lemons', name: 'Lemons', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'apricots', name: 'Apricots', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'prickly-pears', name: 'Prickly Pears', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'olives', name: 'Olives', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'cat-bed', name: 'Cat Bed', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'mushrooms', name: 'Mushrooms', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
    ArcTradeCatalogItem(id: 'very-comfortable-pillows', name: 'Very Comfortable Pillows', category: 'Material', group: 'Bench Upgrade Material', tags: ['bench', 'upgrade', 'resource'], highDemand: false),
  ];
