...
class _LoadoutMetaPill extends StatelessWidget {
  const _LoadoutMetaPill({required this.label});
...
class _LoadoutActionChip extends StatelessWidget {
  const _LoadoutActionChip({
    required this.icon,
    required this.label,
    required this.onTap,
  });
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 15, color: AppTheme.neonPink),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: accent, size: large ? 24 : 18),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    owned ? subtitle : 'Missing • track or trade',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
