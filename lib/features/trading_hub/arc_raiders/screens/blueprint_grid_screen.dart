    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '$ownedCount / ${allBlueprints.length} owned • $missingCount missing • $dupesCount with dupes',
