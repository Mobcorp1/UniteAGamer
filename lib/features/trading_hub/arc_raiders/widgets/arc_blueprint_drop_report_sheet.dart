...
import 'package:uag_arc_raiders_hub/features/trading_hub/arc_raiders/data/arc_drop_report_options.dart';
...
class _ArcBlueprintDropReportSheetState
  ...
  Future<void> _pickAdditionalBlueprint(int index) async {
    ...
    // Primary blueprint is intentionally allowed here so duplicate finds in the same raid can be reported.
  ...
  Widget _buildAdditionalBlueprintSection() {
    final isRaidReport = _requiresRaidDetails;
    final sourceLabel = _acquisitionSource?.label ?? 'selected source';
      ...
      children: [
        ...
        Text(
          isRaidReport
              ...
              : 'These extra blueprints will use the same obtained source: $sourceLabel. Voice search is enabled when selecting each blueprint.',
          ...
          Container(
            ...
            child: Text(
              _acquisitionSource == null
                  ? 'Select how this blueprint was obtained first, then add any extra blueprints from the same source.'
